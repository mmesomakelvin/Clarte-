    ...
    <button
      ...
      className={`flex items-center w-full px-4 py-3 text-sm font-medium transition-colors duration-200 rounded-lg ${
        isActive
          ...
          : 'text-clarte-gray-500 hover:bg-clarte-gray-100 hover:text-clarte-gray-800'
      }`}
    >
  ...
  return (
    <aside className="w-64 bg-white border-r border-clarte-gray-200 flex flex-col p-4">
      <div className="flex items-center mb-8">
        <h1 className="text-3xl font-bold text-clarte-orange-500 tracking-tight">CLARTE</h1>
      </div>
      <nav className="flex-1 space-y-2">
        ...
        <NavItem
          ...
          icon={
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.826-1.106-2.303 0-3.128C10.463 7.22 11.232 7 12 7s1.536.22 2.092.659c1.106.826 1.106 2.303 0 3.128a3.375 3.375 0 01-4.242 0L12 12" />
            </svg>
          }
        />
        <NavItem
